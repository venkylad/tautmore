...
import QuestionOptions from "../add-questions-to-exam-details/Question-Options";
...
//   };
  ...
  listPage = (name, id) => {
    if (localStorage.getItem("backPageolympiadUrl")) {
        let backPageUrl = localStorage.getItem("backPageolympiadUrl");
        this.props.history.push({
            pathname: `/add-questions-to-olympiad/${backPageUrl}`,
            state: { name: name, id: id },
          });
        // history.push(`/add-questions-to-exam/${backPageUrl}`);
        localStorage.removeItem("backPageolympiadUrl");
      } 
    //   else {
