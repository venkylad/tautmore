...
const ExamsDashboardFilter = () => {
  return (
    <Row>
      <Col sm="4">
      <h4 className="rp-manage-school-header-title">Exams</h4>
      </Col>
      <Col sm="8">
        <div className="data-list-header pull-right d-flex justify-content-between flex-wrap datalistClasses">
          <div className="actions-right rp-manageSchool-head-main-dashboard d-flex flex-wrap mt-sm-0 mt-2">
            <UncontrolledDropdown className="data-list-rows-dropdown rp-manageSchool-head-dashboardd mr-1 d-md-block d-none">
...
export default ExamsDashboardFilter;
